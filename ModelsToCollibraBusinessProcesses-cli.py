...
try:
    foldersToQuery = [getFolder(signavio, folders.get(folder)) for folder in config.get("signavio").get("foldersToQuery") if folders.get(folder)] 
...
consumesAttributeToGet = attributes.get(config.get("signavio").get("consumesAttributeToGet"))
...
producesAttributeToGet = attributes.get(config.get("signavio").get("producesAttributeToGet"))
...
consumesRelationToSet = relationTypes.get(config.get("collibra").get("consumesRelationToSet"))
...
producesRelationToSet = relationTypes.get(config.get("collibra").get("producesRelationToSet"))
